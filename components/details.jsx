  ...
  return (
    <div className="flex ">
      ...
      >
        ...
        <Organic args={""} />
        <p className="text-xl text-whiteC tracking-tight flex-col font-bold leading-[1] ">
          <p className="">contents</p>
          <p className="">may very</p>
...
function Ingredeints({ args }) {
  return (
    <div className={`${args}`}>
      <p className="text-whiteC text-xs text-left leading-[1] mt-4">
        COMPATIBLE TECHNOLIGIES: c, cpp, javascript, react, next, node.js,
...
function Organic({ args }) {
  return (
    <div className={`text-center text-whiteC w-auto ${args}`}>
...
function Recycle() {
  return (
    <div className=" flex-col  justify-center items-center w-[80px]">
      ...
      <p className="text-whiteC text-xs text-center mt-[-6px] w-[80px]">Biodegradeable</p>
    </div>
  );
}
